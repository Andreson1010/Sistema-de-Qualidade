...
peso = np.random.uniform(100, 501, 1255)
temperatura_interna = np.random.uniform(60, 100, 1255)
ph = np.random.uniform(3.5, 7.5, 1255)
nivel_umidade = np.random.uniform(5, 30, 1255)
tempo_cozimento = np.random.uniform(10, 120, 1255)
...
arquivo_final = os.path.join(modelo_dir, "modelo_qualidade_aivk.pkl")
if os.path.exists(arquivo_final):
    backup_nome = datetime.now().strftime("modelo_qualidade_aivk_%Y%m%d_%H%M%S.pkl")
